...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    <TD height="600" bgColor=#f1f3f9>
     ...
     <form method="POST" action="saveInfo.do">
      <p>手机号码：
      	<select name="T1" id="T1">
      		
      	</select>
      	 <a href="javascript:void(0)" onclick="nextY()">下一页</a>
      </p>
      <input type="hidden" value="1" name="yeshu" id="Y1">
     
      <p>漫游状态：<input type="radio" name="R1" value="省内漫游" checked>省内漫游 <input type="radio" name="R1" value="V5">国内漫游 
      <input type="radio" name="R1" value="国际漫游">国际漫游</p>
      <p>通话级别：<input type="radio" value="本地通话" checked name="R2">本地通话 
      <input type="radio" name="R2" value="国内长途">国内长途 <input type="radio" name="R2" value="国际长途">国际长途</p>
      <p>客户ID：<input type="text" name="T2" size="20" value="${currentCustomer.customerID}" readonly></p>
